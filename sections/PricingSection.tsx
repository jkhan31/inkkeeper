            ...
            <div className="max-w-3xl mx-auto text-center">
                ...
                <div className="ink-card !p-12 border-2 border-seal-rust/20 shadow-xl relative overflow-hidden">
                    ...
                    <ul className="text-left space-y-4 mb-10 max-w-xs mx-auto">
                        ...
                        <li className="flex items-center gap-3 text-sumi-ink/80"><Check size={18} className="text-seal-rust" /> Full reflections archive</li>
                        <li className="flex items-center gap-3 text-sumi-ink/80"><Check size={18} className="text-seal-rust" /> Search and export</li>
                    </ul>
