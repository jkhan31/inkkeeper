...
export function HeroSection({ onNavigate }: HeroSectionProps) {
    return (
        <section className="relative min-h-[85vh] flex flex-col justify-center px-6 lg:px-10 py-32 bg-rice-paper">
            <div className="max-w-7xl mx-auto w-full relative z-10">
                <div className="max-w-3xl ink-card !p-8 lg:!p-12 mb-12">
